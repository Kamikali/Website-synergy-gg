...
$sql = "SELECT uid, title, user_uid, country, date, thumbnail_path, ispic, coins, visible FROM posts WHERE showOnFrontpage = 1 AND visible = 1 ORDER BY uid DESC";
  ...
  if (mysqli_num_rows($result) > 0) {
      ...
      $title = strlen($row['title']) > 35 ? substr($row['title'],0,35)."..." : $row['title'];
      ...
      echo '            <div class="panel panel-default" style="font-size:13px;">
